...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    ...
    for (var i = 0; i < pContain.length; i++) {
      ...
      pContain[i].style.width = newwidth;
    }
  }
...
//I used Paul Lewis's debouncing method for my scroll events because my pizza site was constantly being reflowed and repainted in the for loop.
...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
   var  phase = Math.sin(currentScrollY + (i % 5)) * 100 + items[i].basicLeft ;
